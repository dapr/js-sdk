...
rm -rf "$PATH_ROOT/src/grpc/proto"
mkdir -p "$PATH_ROOT/src/grpc/proto"

echo ""
echo "Downloading latest Dapr gRPC files"
downloadFile "https://raw.githubusercontent.com/dapr/dapr/master/dapr/proto/common/v1/common.proto" "$PATH_ROOT/src/grpc/proto/dapr/proto/common/v1/common.proto"
downloadFile "https://raw.githubusercontent.com/dapr/dapr/master/dapr/proto/runtime/v1/appcallback.proto" "$PATH_ROOT/src/grpc/proto/dapr/proto/runtime/v1/appcallback.proto"
downloadFile "https://raw.githubusercontent.com/dapr/dapr/master/dapr/proto/runtime/v1/dapr.proto" "$PATH_ROOT/src/grpc/proto/dapr/proto/runtime/v1/dapr.proto"
...
generateGrpc "$PATH_ROOT/src/grpc/proto" "dapr/proto/common/v1/common.proto"
