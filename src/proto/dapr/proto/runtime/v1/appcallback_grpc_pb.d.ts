...
interface IAppCallbackService_IOnInvoke
...
interface IAppCallbackService_IListTopicSubscriptions
  extends grpc.MethodDefinition<
...
interface IAppCallbackService_IOnTopicEvent
  extends grpc.MethodDefinition<
    dapr_proto_runtime_v1_appcallback_pb.TopicEventRequest,
    dapr_proto_runtime_v1_appcallback_pb.TopicEventResponse
  > {
...
interface IAppCallbackService_IListInputBindings
  extends grpc.MethodDefinition<
    google_protobuf_empty_pb.Empty,
    dapr_proto_runtime_v1_appcallback_pb.ListInputBindingsResponse
  > {
...
interface IAppCallbackService_IOnBindingEvent
  extends grpc.MethodDefinition<
    dapr_proto_runtime_v1_appcallback_pb.BindingEventRequest,
    dapr_proto_runtime_v1_appcallback_pb.BindingEventResponse
  > {
...
export interface IAppCallbackServer extends grpc.UntypedServiceImplementation {
  ...
  listTopicSubscriptions: grpc.handleUnaryCall<
    ...
    dapr_proto_runtime_v1_appcallback_pb.ListTopicSubscriptionsResponse
  >;
  onTopicEvent: grpc.handleUnaryCall<
    dapr_proto_runtime_v1_appcallback_pb.TopicEventRequest,
    dapr_proto_runtime_v1_appcallback_pb.TopicEventResponse
  >;
  listInputBindings: grpc.handleUnaryCall<
    google_protobuf_empty_pb.Empty,
    dapr_proto_runtime_v1_appcallback_pb.ListInputBindingsResponse
  >;
  onBindingEvent: grpc.handleUnaryCall<
    dapr_proto_runtime_v1_appcallback_pb.BindingEventRequest,
    dapr_proto_runtime_v1_appcallback_pb.BindingEventResponse
  >;
}
...
export interface IAppCallbackClient {
  ...
  listTopicSubscriptions(
    ...
    callback: (
      ...
      response: dapr_proto_runtime_v1_appcallback_pb.ListTopicSubscriptionsResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  listTopicSubscriptions(
    request: google_protobuf_empty_pb.Empty,
  ...
  onTopicEvent(
    request: dapr_proto_runtime_v1_appcallback_pb.TopicEventRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: dapr_proto_runtime_v1_appcallback_pb.TopicEventResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  onTopicEvent(
    request: dapr_proto_runtime_v1_appcallback_pb.TopicEventRequest,
  ...
  listInputBindings(
    ...
    callback: (
      error: grpc.ServiceError | null,
      response: dapr_proto_runtime_v1_appcallback_pb.ListInputBindingsResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  listInputBindings(
    request: google_protobuf_empty_pb.Empty,
  ...
  onBindingEvent(
    request: dapr_proto_runtime_v1_appcallback_pb.BindingEventRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: dapr_proto_runtime_v1_appcallback_pb.BindingEventResponse,
    ) => void,
  ): grpc.ClientUnaryCall;
  onBindingEvent(
    request: dapr_proto_runtime_v1_appcallback_pb.BindingEventRequest,
