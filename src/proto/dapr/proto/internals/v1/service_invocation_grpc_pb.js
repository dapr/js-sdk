...
var dapr_proto_internals_v1_reminders_pb = require('../../../../dapr/proto/internals/v1/reminders_pb.js');
...
function serialize_dapr_proto_internals_v1_Reminder(arg) {
  if (!(arg instanceof dapr_proto_internals_v1_reminders_pb.Reminder)) {
    throw new Error('Expected argument of type dapr.proto.internals.v1.Reminder');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_dapr_proto_internals_v1_Reminder(buffer_arg) {
  return dapr_proto_internals_v1_reminders_pb.Reminder.deserializeBinary(new Uint8Array(buffer_arg));
}
...
callActorReminder: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: dapr_proto_internals_v1_reminders_pb.Reminder,
    responseType: google_protobuf_empty_pb.Empty,
    requestSerialize: serialize_dapr_proto_internals_v1_Reminder,
    requestDeserialize: deserialize_dapr_proto_internals_v1_Reminder,
...
exports.ServiceInvocationClient = grpc.makeGenericClientConstructor(ServiceInvocationService, 'ServiceInvocation');
