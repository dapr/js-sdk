...
interface ICAService_ISignCertificate
  extends grpc.MethodDefinition<
    dapr_proto_sentry_v1_sentry_pb.SignCertificateRequest,
...
export interface ICAServer extends grpc.UntypedServiceImplementation {
  signCertificate: grpc.handleUnaryCall<
    dapr_proto_sentry_v1_sentry_pb.SignCertificateRequest,
    dapr_proto_sentry_v1_sentry_pb.SignCertificateResponse
  >;
}
...
export interface ICAClient {
  signCertificate(
    request: dapr_proto_sentry_v1_sentry_pb.SignCertificateRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: dapr_proto_sentry_v1_sentry_pb.SignCertificateResponse,
    ) => void,
