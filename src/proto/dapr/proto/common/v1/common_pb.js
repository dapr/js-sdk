  ...
  proto.dapr.proto.common.v1.InvokeRequest.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        httpExtension:
          (f = msg.getHttpExtension()) && proto.dapr.proto.common.v1.HTTPExtension.toObject(includeInstance, f),
      };
...
proto.dapr.proto.common.v1.InvokeRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(4, f, proto.dapr.proto.common.v1.HTTPExtension.serializeBinaryToWriter);
  }
};
...
proto.dapr.proto.common.v1.InvokeResponse.prototype.getData = function () {
  return /** @type{?proto.google.protobuf.Any} */ (jspb.Message.getWrapperField(this, google_protobuf_any_pb.Any, 1));
};
...
proto.dapr.proto.common.v1.StateItem.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getEtag();
  if (f != null) {
    writer.writeMessage(3, f, proto.dapr.proto.common.v1.Etag.serializeBinaryToWriter);
  }
  ...
  if (f != null) {
    writer.writeMessage(5, f, proto.dapr.proto.common.v1.StateOptions.serializeBinaryToWriter);
  }
};
...
proto.dapr.proto.common.v1.StateOptions.prototype.getConcurrency = function () {
  return /** @type {!proto.dapr.proto.common.v1.StateOptions.StateConcurrency} */ (
