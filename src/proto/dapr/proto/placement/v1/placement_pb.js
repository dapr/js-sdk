...
proto.dapr.proto.placement.v1.PlacementOrder.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getTables();
  if (f != null) {
    writer.writeMessage(1, f, proto.dapr.proto.placement.v1.PlacementTables.serializeBinaryToWriter);
  }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.dapr.proto.placement.v1.PlacementTables.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        entriesMap: (f = msg.getEntriesMap())
          ? f.toObject(includeInstance, proto.dapr.proto.placement.v1.PlacementTable.toObject)
          : [],
      ...
      case 1:
        ...
        reader.readMessage(value, function (message, reader) {
          jspb.Map.deserializeBinary(
            ...
            proto.dapr.proto.placement.v1.PlacementTable.deserializeBinaryFromReader,
            "",
            new proto.dapr.proto.placement.v1.PlacementTable(),
          );
        });
        break;
      case 2:
...
proto.dapr.proto.placement.v1.PlacementTables.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(
      ...
      proto.dapr.proto.placement.v1.PlacementTable.serializeBinaryToWriter,
    );
  }
...
proto.dapr.proto.placement.v1.PlacementTables.prototype.getEntriesMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.dapr.proto.placement.v1.PlacementTable>} */ (
    jspb.Message.getMapField(this, 1, opt_noLazyCreate, proto.dapr.proto.placement.v1.PlacementTable)
  );
};
  ...
  proto.dapr.proto.placement.v1.PlacementTable.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        loadMapMap: (f = msg.getLoadMapMap())
          ? f.toObject(includeInstance, proto.dapr.proto.placement.v1.Host.toObject)
          : [],
      ...
      case 3:
        ...
        reader.readMessage(value, function (message, reader) {
          jspb.Map.deserializeBinary(
            ...
            jspb.BinaryReader.prototype.readString,
            jspb.BinaryReader.prototype.readMessage,
            proto.dapr.proto.placement.v1.Host.deserializeBinaryFromReader,
            "",
            new proto.dapr.proto.placement.v1.Host(),
          );
        });
        break;
      case 4:
...
proto.dapr.proto.placement.v1.PlacementTable.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(
      ...
      jspb.BinaryWriter.prototype.writeString,
      jspb.BinaryWriter.prototype.writeMessage,
      proto.dapr.proto.placement.v1.Host.serializeBinaryToWriter,
    );
  }
...
proto.dapr.proto.placement.v1.PlacementTable.prototype.getHostsMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<number,string>} */ (jspb.Message.getMapField(this, 1, opt_noLazyCreate, null));
};
...
proto.dapr.proto.placement.v1.PlacementTable.prototype.getLoadMapMap = function (opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.dapr.proto.placement.v1.Host>} */ (
    jspb.Message.getMapField(this, 3, opt_noLazyCreate, proto.dapr.proto.placement.v1.Host)
  );
};
