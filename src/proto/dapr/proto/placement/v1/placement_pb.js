  ...
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.dapr.proto.placement.v1.PlacementTable.deserializeBinaryFromReader, "");
         });
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
...
proto.dapr.proto.placement.v1.PlacementTable.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    sortedSetList: jspb.Message.getRepeatedField(msg, 2),
...
proto.dapr.proto.placement.v1.PlacementTable.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      msg.setSortedSetList(value);
      break;
    case 3:
      var value = msg.getLoadMapMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.dapr.proto.placement.v1.Host.deserializeBinaryFromReader, "");
         });
      break;
    case 4:
...
proto.dapr.proto.placement.v1.Host.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    entitiesList: jspb.Message.getRepeatedField(msg, 4),
