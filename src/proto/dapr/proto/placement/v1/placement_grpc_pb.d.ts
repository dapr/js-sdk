...
interface IPlacementService_IReportDaprStatus
  extends grpc.MethodDefinition<
    dapr_proto_placement_v1_placement_pb.Host,
    dapr_proto_placement_v1_placement_pb.PlacementOrder
  > {
...
export interface IPlacementServer extends grpc.UntypedServiceImplementation {
  reportDaprStatus: grpc.handleBidiStreamingCall<
    dapr_proto_placement_v1_placement_pb.Host,
    dapr_proto_placement_v1_placement_pb.PlacementOrder
  >;
}
...
export interface IPlacementClient {
  reportDaprStatus(): grpc.ClientDuplexStream<
    dapr_proto_placement_v1_placement_pb.Host,
    dapr_proto_placement_v1_placement_pb.PlacementOrder
  >;
  reportDaprStatus(
