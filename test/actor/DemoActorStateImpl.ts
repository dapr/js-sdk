...
import DemoActorStateInterface from "./DemoActorStateInterface";

export default class DemoActorStateImpl extends AbstractActor implements DemoActorStateInterface {
