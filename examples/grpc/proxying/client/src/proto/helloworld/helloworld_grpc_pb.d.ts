...
interface IGreeterService_ISayHello
  extends grpc.MethodDefinition<helloworld_helloworld_pb.HelloRequest, helloworld_helloworld_pb.HelloReply> {
...
export interface IGreeterClient {
  sayHello(
    request: helloworld_helloworld_pb.HelloRequest,
    callback: (error: grpc.ServiceError | null, response: helloworld_helloworld_pb.HelloReply) => void,
